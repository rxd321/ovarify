...
def main():
    ...
    if request.method == "POST":
        ...
        return render_template("index.html", original_input={'Age':age,'CEA':cea,'IBIL':ibil,NEU','Menopause':meno,,'CA125':ca125,'ALB':alb,'HE4':he4,'GLO':glo,'LYM%':lym}, result=true, prediction=prediction)
